...
const tabItems = [
  ...
  { id: "contacts" as const, label: "联系人", icon: Users, methods: ["contacts.list", "contacts.add"] },
  { id: "tasks" as const, label: "事项", icon: ClipboardList, methods: ["collaboration.state", "approval.respond"] },
