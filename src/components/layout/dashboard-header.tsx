...
export function DashboardHeader({ user }: { user: { name?: string | null; email?: string | null } }) {
  ...
  return <header className="relative z-20 flex min-h-12 shrink-0 flex-wrap items-center gap-2 border-b bg-card px-3 py-1">
    <Dialog open={menuOpen} onOpenChange={setMenuOpen}>
      <DialogTrigger asChild><Button variant="ghost" size="icon" className="-ml-2 md:hidden" aria-label="打开导航"><Menu className="h-5 w-5" /></Button></DialogTrigger>
