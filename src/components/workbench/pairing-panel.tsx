...
const methodLabels: Record<string, string> = { capabilities: "连接检查", "contacts.list": "联系人", "contacts.add": "添加联系人", "collaboration.state": "协作事项", "inbox.list": "收件箱", "conversation.send": "发送消息", "conversation.get": "读取对话", "attention.list": "持久提醒同步", "approval.respond": "远程确认" };
