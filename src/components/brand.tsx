...
export function Brand({ compact = false }: { compact?: boolean }) {
  return <span className="inline-flex items-center gap-3">
    ...
    {!compact && <span className="text-lg font-semibold tracking-tight">Agent Comm<span className="mt-0.5 block text-xs font-medium tracking-[0.16em] text-muted-foreground">你的 AGENT，随时协作</span></span>}
  </span>;
}
