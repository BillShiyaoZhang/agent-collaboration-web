...
import { record, records, string, type RemoteRecord, type RpcMethod } from "./workbench-client";
import type { WorkspaceAgent, WorkspaceConnection, WorkspaceOverview, WorkspaceSubmission, WorkspaceSync } from "./workspace-types";
